...
<h2 style="margin-top:0;color:#2f3e46;">Nueva solicitud de cotizacion</h2>
<p>Se recibio una nueva solicitud desde el sitio web:</p>
<table role="presentation" width="100%" cellpadding="6" style="border-collapse:collapse;">
  ...
  <tr><td style="font-weight:bold;">Telefono</td><td><?= htmlspecialchars($cotizacion['telefono'], ENT_QUOTES, 'UTF-8') ?></td></tr>
  ...
  <tr><td style="font-weight:bold;">Paquete</td><td><?= htmlspecialchars($cotizacion['paquete_titulo'] ?? 'Cotizacion general', ENT_QUOTES, 'UTF-8') ?></td></tr>
</table>
