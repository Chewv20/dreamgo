...
<strong><?= htmlspecialchars($reserva['paquete_titulo'], ENT_QUOTES, 'UTF-8') ?></strong> se acerca y aún
...
<?php endif; ?>
<p>Si ya realizaste el pago por otro medio, ignora este mensaje. Cualquier duda, contáctanos y con gusto te ayudamos.</p>
