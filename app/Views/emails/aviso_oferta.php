...
<table role="presentation" width="100%" cellpadding="6" style="border-collapse:collapse;">
  <tr><td style="font-weight:bold;width:160px;">Codigo</td><td><?= htmlspecialchars($oferta['codigo'], ENT_QUOTES, 'UTF-8') ?></td></tr>
  <tr><td style="font-weight:bold;">Descuento</td><td><?= htmlspecialchars($valorTexto, ENT_QUOTES, 'UTF-8') ?></td></tr>
  <tr><td style="font-weight:bold;">Valido hasta</td><td><?= date('d/m/Y', strtotime($oferta['fecha_fin'])) ?></td></tr>
</table>
...
<p style="font-size:12px;opacity:0.75;">Si ya no quieres recibir estos avisos, <a href="<?= htmlspecialchars($urlBaja, ENT_QUOTES, 'UTF-8') ?>">date de baja aqui</a>.</p>
