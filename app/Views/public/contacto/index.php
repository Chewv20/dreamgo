<?php /** @var string $whatsapp */ /** @var string $email */ ?>
<section class="seccion contenedor" style="max-width:640px;text-align:center;">
  <h1>Hablemos de tu proximo viaje</h1>
  <p>Escribenos por el canal que prefieras, nuestro equipo te respondera a la brevedad.</p>
