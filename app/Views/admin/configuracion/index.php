...
<form method="post" action="/admin/configuracion">
  ...
  <div class="admin-panel ancho-760">
    ...
    <p class="op-75 mt-neg">Estos datos se muestran en el pie de página del sitio.</p>

    <div class="campo">
      <label for="direccion">Dirección (opcional)</label>
      <input type="text" id="direccion" name="direccion" value="<?= htmlspecialchars($valores['direccion'], ENT_QUOTES, 'UTF-8') ?>" placeholder="Av. Siempre Viva 123, Ciudad de México">
    </div>
    ...
    <div class="admin-form-grid admin-form-grid--2">
      ...
      <div class="campo">
        <label for="email_contacto">Correo de contacto público (opcional)</label>
    ...
    <div class="campo">
      <label for="whatsapp_numero">Número de WhatsApp (formato internacional, sin +)</label>
  ...
  <div class="admin-panel ancho-760">
    ...
    <p class="op-75 mt-neg">Deja en blanco las que no apliquen: su icono no se mostrará en el sitio.</p>
  ...
  <div class="admin-panel ancho-760">
    ...
    <div class="admin-form-grid admin-form-grid--2">
      ...
      <div class="campo">
        <label for="dias_recordatorio_viaje">Días de anticipación para el recordatorio de viaje</label>
      ...
      <div class="campo">
        <label for="dias_recordatorio_saldo">Días antes de la salida para el recordatorio de saldo pendiente</label>
      ...
      <div class="campo">
        <label for="porcentaje_anticipo_reserva">Porcentaje de anticipo al reservar en línea (1-100)</label>
  ...
  <div class="admin-panel ancho-760">
    ...
    <div class="campo">
      <label for="meta_title_default">Título SEO por defecto</label>
    ...
    <div class="campo">
      <label for="meta_description_default">Descripción SEO por defecto</label>
